{
  'description' => '<p> This is the <b>formal</b> division of the sixth KGS Computer Go Tournament. </p>
<p> It is open only to Go-playing programs, known as &quot;bots&quot;; and even for bots, there are restrictions on entry to this formal division. There is also an open division. </p>
...
<p> The rules are given at <a href="http://www.weddslist.com/kgs/rules.html">http://www.weddslist.com/kgs/rules.html</a>. Pay particular attention to the requirements for entry to this <b>formal</b> division. If you cannot meet these requirements, you may still be able to enter the <b>open</b> division. </p>
<p> The schedule should be convenient for Asians and Europeans. I hope that Americans will also compete, leaving their bots connected and running overnight. KGS Computer Go Tournaments will have a variety of schedules, to suit all timezones. </p>
<p> This tournament is currently scheduled as a Round-Robin. If it has more than eight entrants, it will be re-scheduled as a seven-round Swiss, so as to finish within a reasonable time. </p>
<h2>Rules</h2>
<p>Round Robin, Simultaneous Schedule.</p>
<h2>Prizes</h2>
